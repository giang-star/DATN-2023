...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "POQ3Q752"; //Mã website tại VNPAY
    static $vnp_HashSecret = "GHJCENMUXOFJFQNLVFZHTGCWCTZEQXTX"; //Chuỗi bí mật
...
//        $vnp_BankCode = 'NCB';
        ...
        $inputData = array(
            ...
            "vnp_ReturnUrl" => 'http://localhost:8000/' . self::$vnp_Returnurl,
