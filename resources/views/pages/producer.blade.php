              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                  <select name='os'>
                    ...
                    <option value='3CE' {{ Request::input('os') == '3CE' ? 'selected' : '' }}>3CE</option>
                    <option value='Clio' {{ Request::input('os') == 'Clio' ? 'selected' : '' }}>
                        Clio
                    </option>
                    <option value='Mac' {{ Request::input('os') == 'Mac' ? 'selected' : '' }}>
                        Mac
                    </option>
                    <option value='YSL' {{ Request::input('os') == 'YSL' ? 'selected' : '' }}>
                        YSL
                    </option>
                    <option value='KiKO' {{ Request::input('os') == 'KiKO' ? 'selected' : '' }}>
                        KiKO
                    </option>
                    <option value='Kenzo' {{ Request::input('os') == 'Kenzo' ? 'selected' : '' }}>
                        Kenzo
                    </option>
                    <option value='Nars' {{ Request::input('os') == 'Nars' ? 'selected' : '' }}>
                        Nars
                    </option>
                  </select>
                </div>
