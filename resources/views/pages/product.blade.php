                ...
                <div class="col-md-6 col-sm-6">
                    <div class="section-header">
                        ...
                        <div class="section-sub-title">
                          ...
                          <div class="rate-link" onclick="scrollToxx();"><span style="margin-right:20px">Đánh giá sản phẩm: </span><div class="start-vote">{!! Helper::get_start_vote($data['product']->rate) !!}</div></div>
                ...
                <div class="tab-content">
                  <div id="description" class="tab-pane fade in active">
                    <div class="content-description">
                      ...
                      @else
                        <p class="text-center"><strong>{!! $data['product']->information_details !!}</strong></p>
                      @endif
                    </div>
