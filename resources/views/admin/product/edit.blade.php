      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label>Danh mục sản phẩm <span class="text-red">*</span></label>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label>Thương hiệu <span class="text-red">*</span></label>
                <select class="form-control" name="OS" required>
                  <option value="">-- Chọn thương hiệu --</option>
                  <option value="3CE" {{ $product->OS == '3CE' ? 'selected' : '' }}>3CE</option>
                  <option value="Clio" {{ $product->OS == 'Clio' ? 'selected' : '' }}>Clio</option>
                  <option value="Mac" {{ $product->OS == 'Mac' ? 'selected' : '' }}>Mac</option>
                  <option value="YSL" {{ $product->OS == 'YSL' ? 'selected' : '' }}>YSL</option>
                  <option value="KiKO" {{ $product->OS == 'KiKO' ? 'selected' : '' }}>KiKO</option>
                  <option value="Kenzo" {{ $product->OS == 'Kenzo' ? 'selected' : '' }}>Kenzo</option>
                  <option value="Nars" {{ $product->OS == 'Nars' ? 'selected' : '' }}>Nars</option>
                </select>
              </div>
            </div>
            {{-- <div class="col-md-4">
