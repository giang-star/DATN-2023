  ...
  <div class="container">
    <div class="row display-flex">
      <div class="col-md-2 margin-auto trigger-menu">
        ...
        <div class="logo">
          <a class="logo-wrapper" href="{{ route('home_page') }}" title="{{ config('app.name') }}"><img src="{{ asset('images/downlod.png') }}" alt="{{ config('app.name') }}"></a>
        </div>
      </div>
...
<div class="mobile-main-menu">
    ...
    <div class="mb-menu-top-header">
      <div class="mb-menu-logo">
        <a class="logo-wrapper" href="{{ route('home_page') }}" title="{{ config('app.name') }}">
          <img src="{{ asset('images/lo.png') }}" alt="{{ config('app.name') }}">
        </a>
      </div>
  ...
  <div class="mobile-main-menu-bottom">
    <div class="mobile-support">
      ...
      <div class="info-support">
        <i class="fa fa-envelope" aria-hidden="true"></i> EMAIL: <a href="mailto:phonestore@gmail.com" title="phonestore@gmail.com">queenspa@gmail.com</a>
      </div>
    </div>
  </div>
</div>
